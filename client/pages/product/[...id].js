...
export default function ProductPage({ product }) {
    ...
    const buyAtLowPrice = async () => {
        const res = await axios.post('/api/buyadvance', { name, email, city, postalCode: address, streetAddress: address, country: address, limitPrice, pId });
