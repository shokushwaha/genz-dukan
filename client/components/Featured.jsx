            ...
            >
              <Wrapper>
                <Column>
                  <div className='flex flex-col items-center justify-center mt-[-1rem] h-[38rem]'>
                    ...
                    <ButtonWrapper>
                      ...
                      <h1 className='  text-black bg-yellow-300 rounded-md px-2 flex md:gap-2 items-center justify-center'>
                        <svg
                ...
                <Column>
                  <Tilt>
                    <StyledImage
                      src='https://res.cloudinary.com/dt21djrjq/image/upload/v1691917562/yymttc4usxa1foowi9jq.jpg'
                      alt='featured image'
                      className='w-[300px] mt-[5rem]'
                    />
                  </Tilt>
                </Column>
              </Wrapper>
